...
const StudentTable = () => {
  ...
  const [courseName, setCourseName] = useState('');  // Track the course name input
  const [duration, setDuration] = useState('');  // Track the course duration input
  ...
  const handleEdit = (course) => {
    ...
    setCourseName(course.courseName);  // Set the current course name in the input
    setDuration(course.duration);  // Set the current course duration in the input
  ...
  const handleUpdate = async () => {
    ...
    const updatedCourse = { courseName, duration };
