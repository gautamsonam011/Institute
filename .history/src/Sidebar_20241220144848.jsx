...
function Sidebar({ openSidebarToggle, OpenSidebar }) {
  ...
  const [isCertificateOpen, setCertificateOpen] = useSate(false);
  ...
  const toggleCertificates = () => setCertificateOpen(!isCertificateOpen);
      ...
      <ul className="sidebar-list">
        ...
        <li className="sidebar-list-item">
          <div
            ...
            style={{ display: "flex", alignItems: "center", cursor: "pointer" }}
          >
            < BsFillArchiveFill className="icon" /> Certificates
            {isCertificateOpen ? <BsChevronDown /> : <BsChevronRight />}
          </div>
          {isCertificateOpen && (
            <ul className="sidebar-submenu">
              <li>
              <Link to="/CertificatesUpload/certificate">Add Certificate</Link>
              </li>
              <li>
              <Link to="/CertificatesUpload//view-certificate">View All Certificates</Link>
              </li>
            </ul>
          )}
        </li>
