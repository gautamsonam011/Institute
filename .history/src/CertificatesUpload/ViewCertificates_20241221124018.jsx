...
const ViewCertificates = () => {
  ...
  const handleEdit = (new_certificate) => {
    setEditingCertificate(new_certificate);  // Set the certificate being edited
    setCertificate(new_certificate.certificate);  // Set the current certificate name in the input
    setStudentNo(new_certificate.studentNo);  // Set the current student number in the input
