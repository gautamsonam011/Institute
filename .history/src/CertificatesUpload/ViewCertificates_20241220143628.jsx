...
const ViewCertificates = () => {
  ...
  const handleEdit = (new_certificate) => {
    ...
    setCetificate(new_certificate.cetificate);  // Set the current certificates name in the input
  ...
  const handleUpdate = async () => {
    ...
    const updatedCertificate = {cetificate, studentNumber };
          ...
          {courses.length === 0 ? (
            ...
            certificates.map((new_certificate, index) => (
              <tr key={new_certificate.id}>
                <td>{index + 1}</td>
                <td>{new_certificate.studentNumber}</td>
                <td>{new_certificate.cetificate}</td>
                <td>
