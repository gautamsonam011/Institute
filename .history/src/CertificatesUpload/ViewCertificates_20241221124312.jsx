...
const ViewCertificates = () => {
  ...
  const [studentNo, setStudentNo] = useState('');  // Track the course duration input
  ...
  const handleEdit = (new_certificate) => {
    ...
    setStudentNo(new_certificate.studentNo);  // Set the current certificates duration in the input
  ...
  const handleUpdate = async () => {
    ...
    const updatedCertificate = { certificate };  // Only include the data that needs to be updated (e.g., certificate)
    ...
    try {
      ...
      const response = await fetch(url, {
        ...
        body: JSON.stringify(updatedCertificate),  // Send the updated certificate data in the request body
      });
