...
const ViewCertificates = () => {
  ...
  const handleUpdate = async () => {
    ...
    // Create updatedCertificate object including both fields
    const updatedCertificate = { 
      certificate: certificate || editingCertificate.certificate, // Keep the certificate the same if not updated
      studentNo: studentNo || editingCertificate.studentNo,     // Keep the studentNo the same if not updated
    };
    ...
    try {
      ...
      setCertificates(certificates.map(cert => (cert.id === data.id ? data : cert)));
